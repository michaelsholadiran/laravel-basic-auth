 ...
 @if ( Session::get('status'))
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="{{route('subadmin.account.update',['account'=>$user->id])}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                           ...
                           <select name="role" class="form-select">
                            ...
                            <option @if ($user->role == "subadmin")
                                selected
                            @endif value="subadmin">Super Admin</option>
                            <option @if ($user->role == "subadmin")
                                selected
