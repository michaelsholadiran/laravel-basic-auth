    ...
    <div class="wrapper">
      <div id="body" class="active col-10 mx-auto">
         <nav class="navbar navbar-expand-lg navbar-white bg-white">
            <div> <a href="{{route('user.dashboard.index')}}">Dashboard</a></div>
                ...
                <li class="nav-item dropdown">
                    <div class="nav-dropdown">
                        <a href="#" id="nav2" class="nav-item nav-link dropdown-toggle text-secondary"
                            ...
                            <span>{{ auth('user')->user()->name }}</span> <i
                                style="font-size: .8em;" class="fas fa-caret-down"></i>
                        </a>

                        <div class="dropdown-menu dropdown-menu-end nav-link-menu">
                            <ul class="nav-list">
                                <li><a href="{{route('user.account.index')}}" class="dropdown-item"><i class="fas fa-address-card"></i> Profile</a>
                                </li>
